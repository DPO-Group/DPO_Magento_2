...
class Dpo extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    public function getStandardCheckoutFormFields()
    {
        ...
        $dpo     = new Dpopay( $testMode );
        $dpodata = $this->dataFactory->create();
        ...
        $data['paymentCurrency']   = $order->getOrderCurrencyCode();
    ...
    {
        return $this->_urlBuilder->getUrl( 'dpo/redirect/success', array( '_secure' => true ) );
    }
    ...
    {
        return $this->_urlBuilder->getUrl( 'dpo/notify', array( '_secure' => true ) );
    }
