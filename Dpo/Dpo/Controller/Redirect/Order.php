...
class Order extends AbstractDpo
{
    ...
    public function setPaymentMethod()
    {
        ...
        $quote->setPaymentMethod( 'dpo' );
        $quote->setInventoryProcessed( false );

        // Set Sales Order Payment
        $quote->getPayment()->importData( ['method' => 'dpo'] );
        // Now Save Quote
        $quote->save();
    ...
    {
        $data = $this->_paymentMethod->getStandardCheckoutFormFields();
        ...
        if ( $data ) {
            ...
            throwException( 'There was an error. Please try again...' );
        }
    }
